...
function VariantTabs({ variantId, setVariantId }) {
  const [expanded, setExpanded] = useState(variantId.startsWith("uzywany"));
  ...
  return (
    <div>
      ...
      {/* Lista konkretnych egzemplarzy używanych - bez s.n. w widoku.
          Wybrany egzemplarz ma rozwinięte szczegóły inline (stan + akcesoria
          + gwarancja) żeby klient widział różnicę przy przełączaniu. */}
      {expanded && isUzywanyActive && (
          ...
          {uzywaneIds.map((id) => {
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  >
                    <div style={{ display: "flex", alignItems: "center", gap: 12, flex: 1 }}>
                      ...
                      <div style={{ flex: 1 }}>
                        {/* Tytuł egzemplarza = ocena stanu (to czym klient
                            faktycznie porównuje egz. między sobą). Badge obok
                            = liczba ze skali "Stan 9/10", bez powtarzania
                            słownej oceny, żeby nie było redundancji. */}
                        <div style={{ fontSize: 14, fontWeight: 700, color: "#000", display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
                        ...
                        {/* W zwiniętej karcie - gwarancja z ikoną tarczy.
                            Akcesoria i faktura pokazują się po wyborze egz. */}
                        <div
                          style={{
                            fontSize: 12,
                            color: BODY,
                ...
                {/* Szczegóły stanu/akcesoriów/gwarancji rozwinięte tylko
                    w karcie wybranego egzemplarza - blisko punktu decyzji. */}
                {selected && (
                  <div
                    style={{
                  ...
                  >
                    ...
                    <div>
                      ...
                      {/* Gwarancja jest już w nagłówku karty egzemplarza
                          (z ikoną tarczy); faktura - w czarnym banerze NAD
                          cenami. Tu nic dodatkowego nie powielamy. */}
                    </div>
                  </div>
                )}
              </div>
