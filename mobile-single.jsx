...
const VARIANTS = {
  ...
  // SINGLE-INSTANCE: jest tylko 1 egzemplarz używany - typowy scenariusz
  // dla używanych (każdy używany to unikat). Nie pokazujemy listy wyboru,
  // tylko od razu rozwinięte szczegóły tego egzemplarza.
  uzywany: {
    id: "uzywany",
    label: "Używany",
...
// SINGLE-INSTANCE: pojedynczy egzemplarz używany pokazywany od razu
// z rozwiniętymi szczegółami (bez listy wyboru). Typowy scenariusz,
// bo używane to unikaty - zwykle mamy 1 sztukę danego modelu.
function UsedInstanceSingle() {
  ...
  return (
    <div style={{ padding: "12px 14px" }}>
      ...
      >
        ...
        {/* Szczegóły zawsze rozwinięte - nie ma nic do wybrania. */}
    ...
    >
      ...
      >
        ...
        <div style={{ flex: 1, overflow: "auto", paddingBottom: 4 }}>
          ...
          {/* Single-instance: 1 egzemplarz pokazywany od razu z pełnymi
              szczegółami. Bez listy wyboru, bez "wybierz egzemplarz". */}
          {isUsed && <UsedInstanceSingle />}
